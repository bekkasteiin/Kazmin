...
class ViewMaterialRequest extends StatelessWidget {
  const ViewMaterialRequest({Key key}) : super(key: key);
      ...
      body: SingleChildScrollView(
        child: Column(
          children: <Widget>[
            ...
            if (request.status.code != 'TO_BE_REVISED')
              KzmContentShadow(
              child: Column(
                children: <Widget>[
                  FieldBones(
            ...
            BpmTaskList<MaterialAssistantViewModel>(model),
            StartBpmProcess(
              model,
              hideCancel: false,
            ),

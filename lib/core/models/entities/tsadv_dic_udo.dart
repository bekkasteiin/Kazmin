...
class TsadvDicUdo {
  ...
  static String get entity => 'tsadv\$DicUdo';

  factory TsadvDicUdo.fromJson(String str) {
    return TsadvDicUdo.fromMap(json.decode(str) as Map<String, dynamic>);
  }

  String toJson() => json.encode(toMap());

  factory TsadvDicUdo.fromMap(Map<String, dynamic> json) {
    return TsadvDicUdo(

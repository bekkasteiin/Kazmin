...
class TsadvDicSuitabilityToMilitary {
  String entityName;
  String instanceName;
  bool active;
  String id;
  ...
  static String get entity => 'tsadv\$DicSuitabilityToMilitary';

  factory TsadvDicSuitabilityToMilitary.fromJson(String str) {
    return TsadvDicSuitabilityToMilitary.fromMap(json.decode(str) as Map<String, dynamic>);
  }

  String toJson() => json.encode(toMap());

  factory TsadvDicSuitabilityToMilitary.fromMap(Map<String, dynamic> json) {
    return TsadvDicSuitabilityToMilitary(

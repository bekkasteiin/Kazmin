...
class TsadvDicMilitaryType {
  ...
  static String get entity => 'tsadv\$DicMilitaryType';

  factory TsadvDicMilitaryType.fromJson(String str) {
    return TsadvDicMilitaryType.fromMap(json.decode(str) as Map<String, dynamic>);
  }

  String toJson() => json.encode(toMap());

  factory TsadvDicMilitaryType.fromMap(Map<String, dynamic> json) {
    return TsadvDicMilitaryType(
